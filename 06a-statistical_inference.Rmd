...
ggplot(data.frame(hours)) +
  ...
  annotate("text", x = mean(hours) + 12, y = 1500, 
           label = paste("Average:", round(mean(hours), 2))) +
  annotate("text", x = mean(hours) + 13, y = 1300,
  ...
  annotate("text", x = mean(hours) + 20, y = 950, label = "Mean + 2 * SD" )
```
...
$$
{\bar X - \mu_0 \over s / \sqrt{n}} = {50.15 - 40 \over 0.74} = 13.64
$$
