...
library(ggplot2)
a <- seq(0,4, 2)
plt <- ggplot(data.frame(x=c(0,4)), aes(x))+
...
```{r echo=FALSE}
knitr::include_graphics("./fdist_anova.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./ftest_anova.png")
```
...
<p style="text-align:center;">
$|\overline{Y}_i-\overline{Y}_j | > HSD$ , <br>
</p>
...
<p style="text-align:center;">
$HSD= 3.506\sqrt{\frac{2.96}{10}}=1.906$ <br>
</p>
